...
int main() {
    ...
    int two_year_interest, four_year_interest, six_year_interest;
    int eight_year_interest, ten_year_interest;
    ...
    sum_of_total_interest = two_year_interest + four_year_interest +
                            six_year_interest + eight_year_interest + ten_year_interest;
